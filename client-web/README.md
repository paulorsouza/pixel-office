...
**Cardgame:** use `🃏 Cartas`, no canto superior direito, para montar e salvar seu baralho de
9 cartas. Perto de outro jogador, clique no avatar dele e escolha `Desafiar`; o adversário poderá
aceitar ou recusar pelo convite exibido na tela.
